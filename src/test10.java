...
public class test10 extends AssertJSwingJUnitTestCase {
	...
	public void test10_Gameover() {
		...
		// gamePanel.button("stop").target().doClick());
		Board board = ((GameView) gamePanel.target()).board;
		...
		try {
			...
			th.sleep(6000);
			th.join();
			assertEquals(gamePanel.target().isVisible(), "true");
